        ...
        <div class="row"
            <div claa="col-6 offset-md-3">
                <form id="form_reg" class="bg-light p-4 my-3" action="reg.php" method="post"
                   <h2 class="py-3 text-center text-uppercase"><center>Chỉnh sửa thông tin sách</center></h2>
                   ...
                   <input type="submit" class="btn bt-primary btn-block mt-4" name="btn-reg" value="Lưu">
                </form>
            </div>
         </div>
     </div>
